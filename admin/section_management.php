                    ...
                    <table id="display-table" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=$list['code']?></td>
                                <td><?=$list['program']?></td>
                                <td><?= ordinalSuffix($list['year']) ?> Year</td>
                            </tr>
                            <?php
								}
                        ...
                        <div class="modal-body">
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" min="1" max="4" class="form-control" id="enter_year" name="enter_year" oninput="validity.valid||(value='');" pattern="\d*">
                                </div>
                            </div>
                            <div class="mb-3">
...
<?php 
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["addEntry"])) {
        ...
        $year = $_POST["enter_year"];

        $query = "INSERT INTO sections (code, program, year) VALUES ('$code', '$program', '$year')";
